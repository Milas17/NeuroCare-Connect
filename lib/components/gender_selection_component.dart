...
class GenderSelectionComponent extends StatefulWidget {
  ...
  GenderSelectionComponent({Key? key, this.type, required this.onTap, this.isError = false}) : super(key: key);
          ...
          Row(
            ...
            children: List.generate(
              ...
              (index) {
                    ...
                    children: [
                      Container(
                        ...
                        decoration: boxDecorationDefault(
                          ...
                          border: Border.all(color: isSelected ? primaryColor : secondaryTxtColor.withValues(alpha: 0.5)),
                      ...
                      8.width,
                      Text("${genderList[index].name.validate()}", style: isSelected ? boldTextStyle(size: 14) : primaryTextStyle(size: 14), textAlign: TextAlign.center, maxLines: 1, overflow: TextOverflow.ellipsis).flexible(),
                    ],
                  ).paddingSymmetric(vertical: 4).center(),
                ).appOnTap(
                  () {
                    if (isSelected) {
                      selectedGender = -1;
                ...
                ).paddingRight(index != genderList.length - 1 ? 8 : 0);
              },
            ),
          ),
        ],
