...
class AppointmentSlots extends StatefulWidget {
  ...
  AppointmentSlots({required this.date, required this.clinicId, required this.doctorId, required this.serviceId, this.appointmentTime});
      ...
      children: [
        AppTextField(
          ...
          decoration: inputDecoration(
            ...
            suffixIcon: ic_slots.iconImage(size: 10, color: context.iconColor).paddingAll(14),
          ),
        ),
        16.height,
                        ...
                        AnimatedWrap(
                          ...
                          children: List.generate(
                            ...
                            (i) {
                              ...
                              Color redColor = sessionTimeData.available == false ? errorBackGroundColor.withValues(alpha: 0.4) : context.scaffoldBackgroundColor;
