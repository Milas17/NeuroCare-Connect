...
class _ConfirmAppointmentScreenState extends State<ConfirmAppointmentComponent> {
  ...
  Future<void> saveAppointment() async {
    Map<String, dynamic> req = {
      ...
      "status": appointmentAppStore.bookingStatus,
    };
    if (isUpdate) {
    ...
    await saveAppointmentApi(data: req, files: appointmentAppStore.reportList.map((element) => File(element.path.validate())).toList()).then((value) async {
      ...
      if (isUpdate) {
        ...
        appointmentAppStore.setBookingStatus(null);
