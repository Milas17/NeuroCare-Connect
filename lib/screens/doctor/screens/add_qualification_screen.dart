      ...
      child: AnimatedScrollView(
        ...
        children: [
          ...
          AppTextField(
            ...
            validator: (value) => value!.trim().isEmpty ? 'Degree Required' : null,
          ...
          AppTextField(
            ...
            textInputAction: TextInputAction.next,
            textFieldType: TextFieldType.OTHER,
            validator: (value) => value!.trim().isEmpty ? 'University Required' : null,
            decoration: inputDecoration(
              context: context,
          ...
          AppTextField(
            ...
            textFieldType: TextFieldType.OTHER,
            validator: (value) => value!.trim().isEmpty ? 'Year Required' : null,
            decoration: inputDecoration(
              context: context,
          ...
          AppButton(
              ...
              onTap: () {
                if (formKey.currentState!.validate()) {
                  ...
                  finish(context);
                  toast('Qualification Added Successfully');
                }
              },
