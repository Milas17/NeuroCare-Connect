        ...
        children: [
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      8.width,
                      Marquee(
                        child: Text(isDoctor() ? data.userName.validate().prefixText(value: '${locale.lblDr}') : data.userName.validate(), style: boldTextStyle(size: 16)),
                      ).expand(),
                    ],
                  ),
                  8.height,
          ...
          Positioned(
            ...
            child: StatusWidget(
              ...
              backgroundColor: getHolidayStatusColor(isPending, isOnLeave).withValues(alpha: 0.5),
            ),
          ),
        ],
      ),
