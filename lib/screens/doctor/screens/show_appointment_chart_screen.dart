                    ...
                    child: ButtonTheme(
                      ...
                      child: DropdownButton<DropDownOptionsClass>(
                        ...
                        items: statsOptions.validate().map<DropdownMenuItem<DropDownOptionsClass>>((DropDownOptionsClass value) {
                          bool isLast = statsOptions.validate().indexOf(value) == statsOptions.length - 1;
                          return DropdownMenuItem<DropDownOptionsClass>(
                            value: value,
                            child: Container(
                              decoration: BoxDecoration(
                                border: !isLast ? Border(bottom: BorderSide(color: appPrimaryColor)) : null,
                              ),
                        ...
                        selectedItemBuilder: (BuildContext context) {
                          return statsOptions.map((DropDownOptionsClass value) {
                            return Container(
                              padding: EdgeInsets.zero,
                              alignment: Alignment.centerLeft,
                              margin: EdgeInsets.zero,
                    ...
                    child: ButtonTheme(
                      ...
                      child: DropdownButton<DropDownOptionsClass>(
                        ...
                        items: dropDownList.validate().map<DropdownMenuItem<DropDownOptionsClass>>((DropDownOptionsClass value) {
                          bool isLast = dropDownList.validate().indexOf(value) == dropDownList!.length - 1;
                          return DropdownMenuItem<DropDownOptionsClass>(
                            value: value,
                            child: Container(
                              decoration: BoxDecoration(
                        ...
                        selectedItemBuilder: (BuildContext context) {
                          return dropDownList.validate().map((DropDownOptionsClass value) {
                            return Container(
                              padding: EdgeInsets.zero,
                              alignment: Alignment.centerLeft,
                              margin: EdgeInsets.zero,
