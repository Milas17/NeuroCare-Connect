...
(List<EncounterType> encounterOtherTypeList, {String? emptyText}) getEncounterOtherTypeListData({required String encounterType, required EncounterModel encounterData}) {
  switch (encounterType) {
    case PROBLEM:
      return (encounterData.problem.validate(), emptyText: encounterData.problem.validate().isEmpty ? locale.lblNoProblemFound.capitalizeFirstLetter() : null);
    case OBSERVATION:
      return (encounterData.observation.validate(), emptyText: encounterData.observation.validate().isEmpty ? locale.lblNoObservationsFound.capitalizeFirstLetter() : null);
    case NOTE:
      return (encounterData.note.validate(), emptyText: encounterData.note.validate().isEmpty ? locale.lblNoNotesFound.capitalizeFirstLetter() : null);
    default:
      return ([], emptyText: '');
  }
}
