          ...
          children: [
            if (showEdit)
              SlidableAction(
                ...
                borderRadius: showBillDetails || showEncounterDashboard ? BorderRadius.only(topLeft: Radius.circular(defaultRadius), bottomLeft: Radius.circular(defaultRadius)) : BorderRadius.circular(defaultRadius),
                icon: Icons.edit,
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      RoleWidget(
                        isShowPatient: true,
                        isShowReceptionist: true,
                        child: Text('${billData.doctorName.validate().capitalizeEachWord().prefixText(value: '${locale.lblDr} ')}', style: primaryTextStyle(color: appPrimaryColor, size: isPatient() ? 14 : 16)),
                      ),
                      2.height,
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          if (billData.totalTax != null) PriceWidget(price: billData.totalTax.validate().toStringAsFixed(2), textSize: 14).expand(),
