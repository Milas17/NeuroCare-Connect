...
import 'package:kivicare_flutter/screens/shimmer/screen/service_data_shimmer.dart';
                ...
                Align(
                  ...
                  child: Wrap(
                    ...
                    children: List.generate(
                      serviceList.length,
                      (index) {
                        log("=======clinic length => ${serviceList.length}");
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              FittedBox(
                                                ...
                                                durationList
                                                    .firstWhere(
                                                      (element) => element.value == serviceData.duration.toInt(),
                                                      orElse: () => DurationModel(label: 'Unknown', value: 0),
                                                    )
                                                    .label
                                                    .validate(),
                                                style: primaryTextStyle(size: 14),
