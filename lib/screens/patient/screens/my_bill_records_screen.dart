            ...
            SnapHelperWidget<List<BillListData>>(
              ...
              onSuccess: (snap) {
                ...
                return AnimatedScrollView(
                  ...
                  children: [
                    if (!isPatient()) Text('${locale.lblNote} :  ${locale.lblSwipeLeftForInvoice}', style: secondaryTextStyle(size: 10, color: appSecondaryColor)),

                    ///To do add language key
                    if (isPatient() && (showBillDetails || showEncounterDashboard)) Text('${locale.lblNote} :  ${locale.lblSwipeToView}', style: secondaryTextStyle(size: 10, color: appSecondaryColor)),
                    8.height,
                    ...snap.map((billData) {
