                  ...
                  children: [
                    if (doctorData.profileImage.validate().isNotEmpty)
                      ...
                      PlaceHolderWidget(
                        ...
                        child: Text(doctorData.displayName.validate().isNotEmpty ? doctorData.displayName.validate()[0] : '', style: boldTextStyle(color: appStore.isDarkModeOn ? Colors.white : Colors.black, size: titleTextSize)),
                        height: 100,
                    ...
                    Column(
                      children: [
                        Text(
                          doctorData.displayName.validate().prefixText(value: '${locale.lblDr}'),
