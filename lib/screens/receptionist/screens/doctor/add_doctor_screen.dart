                ...
                Wrap(
                  ...
                  children: [
                    ...
                    genderCont.text.isEmpty
                        ...
                        : SizedBox.shrink(), // Invisible when text is not empty
                    GestureDetector(
                      onTap: () {
                        MultiSelectSpecialization(selectedServicesId: multiSelectStore.selectedStaticData.validate().map((element) => element!.id.validate()).toList())
                            ...
                            .whenComplete(
                          () {
                            if (multiSelectStore.selectedStaticData.isNotEmpty) {
                              multiSelectStore.isSpecialized = false;
                            }
                          },
                        );
                      },
                      child: Observer(builder: (context) {
                        return Container(
                          ...
                          width: context.width(),
                          decoration: boxDecorationDefault(borderRadius: radius(), border: Border.all(color: multiSelectStore.isSpecialized ? errorColor : Colors.transparent), color: context.cardColor),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
      ...
      bottomNavigationBar: AppButton(
        ...
        onTap: () {
          if (multiSelectStore.selectedStaticData.isNotEmpty) {
            ...
            multiSelectStore.isSpecialized = true;
          }

          if (formKey.currentState!.validate()) {
            if (genderCont.text.isEmptyOrNull) {
              return;
            } else if (multiSelectStore.selectedStaticData.isEmpty) {
              return;
            }
