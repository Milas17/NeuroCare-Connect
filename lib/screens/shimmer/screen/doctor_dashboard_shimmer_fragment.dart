    ...
    return Wrap(
      ...
      children: [
                  ...
                  ShimmerComponent(
                    child: Container(
                      decoration: boxDecorationDefault(
                        color: primaryColor.withValues(alpha: 0.080),
                        boxShadow: [],
                        borderRadius: radius(),
                      ),
                      child: Column(
                  ...
                  Positioned(
                    ...
                    child: ShimmerComponent(
                      child: Container(
                        ...
                        decoration: boxDecorationDefault(color: primaryColor.withValues(alpha: 0.3), boxShadow: [], shape: BoxShape.circle),
                      ),
                    ),
                  )
                ],
        ...
        Container(
          ...
          decoration: boxDecorationDefault(
            color: primaryColor.withValues(alpha: 0.030),
            boxShadow: [],
            borderRadius: radius(),
          ),
          child: Column(
