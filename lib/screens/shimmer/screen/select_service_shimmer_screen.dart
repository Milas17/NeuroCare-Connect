              ...
              children: [
                ShimmerComponent(
                  child: Container(
                    ...
                    decoration: boxDecorationDefault(boxShadow: [], color: primaryColor.withValues(alpha: 0.6), shape: BoxShape.circle),
                  ),
                ),
                16.width,
                Column(
                  ...
                  children: [
                    ShimmerComponent(
                      child: Container(
                        ...
                        decoration: boxDecorationDefault(boxShadow: [], color: primaryColor.withValues(alpha: 0.6)),
                      ),
                    ),
                    4.height,
                    ShimmerComponent(
