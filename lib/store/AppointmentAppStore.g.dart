...
mixin _$AppointmentAppStore on AppointmentAppStoreBase, Store {
  ...
  late final _$bookingStatusAtom =
      Atom(name: 'AppointmentAppStoreBase.bookingStatus', context: context);
  ...
  late final _$setSelectedDoctorAsyncAction = AsyncAction(
      'AppointmentAppStoreBase.setSelectedDoctor',
      context: context);

  @override
  Future<void> setSelectedDoctor(UserModel? aSelected) {
    return _$setSelectedDoctorAsyncAction
        .run(() => super.setSelectedDoctor(aSelected));
  }

  late final _$setSelectedClinicAsyncAction = AsyncAction(
      'AppointmentAppStoreBase.setSelectedClinic',
      context: context);

  @override
  Future<void> setSelectedClinic(Clinic? aSelected) {
    return _$setSelectedClinicAsyncAction
        .run(() => super.setSelectedClinic(aSelected));
  }

  late final _$setSelectedPatientAsyncAction = AsyncAction(
      'AppointmentAppStoreBase.setSelectedPatient',
      context: context);

  @override
  Future<void> setSelectedPatient(String? aName) {
    return _$setSelectedPatientAsyncAction
        .run(() => super.setSelectedPatient(aName));
  }

  late final _$setSelectedPatientIdAsyncAction = AsyncAction(
      'AppointmentAppStoreBase.setSelectedPatientId',
      context: context);

  @override
  Future<void> setSelectedPatientId(int? aStatus) {
    return _$setSelectedPatientIdAsyncAction
        .run(() => super.setSelectedPatientId(aStatus));
  }
  ...
  @override
  void setBookingStatus(int? status) {
    final _$actionInfo = _$AppointmentAppStoreBaseActionController.startAction(
        name: 'AppointmentAppStoreBase.setBookingStatus');
    try {
      return super.setBookingStatus(status);
    } finally {
      _$AppointmentAppStoreBaseActionController.endAction(_$actionInfo);
    }
  }
